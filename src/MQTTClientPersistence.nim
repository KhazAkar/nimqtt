...
when not defined(MQTTCLIENTPERSISTENCE_H):
  ##
  ## /// @endcond
  ##
  ##
  ...
  ##
  const
    MQTTCLIENT_PERSISTENCE_ERROR* = -2
  ##
  ...
  ##
  type
    Persistence_open* = proc (handle: ptr pointer; clientID: cstring;
                           serverURI: cstring; context: pointer): cint {.cdecl.}
  ##
  ...
  ##
  type
    Persistence_close* = proc (handle: pointer): cint {.cdecl.}
  ##
  ...
  ##
  type
    Persistence_put* = proc (handle: pointer; key: cstring; bufcount: cint;
                          buffers: ptr cstring; buflens: ptr cint): cint {.cdecl.}
  ##
  ...
  ##
  type
    Persistence_get* = proc (handle: pointer; key: cstring; buffer: cstringArray;
                          buflen: ptr cint): cint {.cdecl.}
  ##
  ...
  ##
  type
    Persistence_remove* = proc (handle: pointer; key: cstring): cint {.cdecl.}
  ##
  ...
  ##
  type
    Persistence_keys* = proc (handle: pointer; keys: ptr cstringArray; nkeys: ptr cint): cint {.
        cdecl.}
  ##
  ...
  ##
  type
    Persistence_clear* = proc (handle: pointer): cint {.cdecl.}
  ##
  ...
  ##
  type
    Persistence_containskey* = proc (handle: pointer; key: cstring): cint {.cdecl.}
  ##
  ...
  ##
  type
    MQTTClient_persistence* {.bycopy.} = object
      ##
  ...
  ##
  type
    MQTTPersistence_beforeWrite* = proc (context: pointer; bufcount: cint;
                                      buffers: ptr cstring; buflens: ptr cint): cint {.
        cdecl.}
  ##
  ...
  ##
  type
    MQTTPersistence_afterRead* = proc (context: pointer; buffer: cstringArray;
                                    buflen: ptr cint): cint {.cdecl.}